...
(function ($) {
    ...
    $.fn.InputSpinner = function (options) {
        ...
        const html = '<div class="input-group ' + config.groupClass + '">' +
            ...
            '</div>' +
            '<input type="text" id="'+config.id+'" style="text-align: ' + config.textAlign + '" class="form-control"/>' +
        ...
        this.each(function () {
            ...
            $input.on("paste keyup change", function (evt) {
                ...
                $original.trigger('change', {currentTarget: $original[0]});
            });
